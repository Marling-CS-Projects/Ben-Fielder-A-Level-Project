...
//Creating the Controls Menu scene. The create function is called at the start of the scene and the update function is called every frame
class ControlsMenu extends Phaser.Scene{
    ...
    create(){
        ...
        this.titleText = createNewText(this, this.texts, {x:400,y:100}, this.gameScale, {text:"Settings", font: "50px Future", fill: "#552eff"})
        ...
        this.creditsButton = createNewButton(this, this.uiButtons, {x:200,y:500,w:200,h:50}, this.gameScale, {text:"Credits", font: "40px Future", fill: "#00ff00"}, 0xff0000, goToCredits, this, "ui-button")
...
function goToCredits(game){
    //load credits menu
    game.scene.start("CreditsMenu")
}
