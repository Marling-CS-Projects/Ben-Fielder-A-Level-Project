...
class Level4 extends Phaser.Scene{
    ...
    create(){
        ...
        this.player1 = createNewPlayer(this, this.players, 50, 2125, this.gameScale)
        this.player2 = createNewPlayer(this, this.players, 750, 225, this.gameScale)
        ...
        this.box1 = createNewBox(this, this.boxes, {x:150,y:2125,w:33,h:33}, this.gameScale)
        this.box2 = createNewBox(this, this.boxes, {x:650,y:225,w:33,h:33}, this.gameScale)
        ...
        this.button1 = createNewButton(this, this.buttons, {x:550,y:1850,w:25,h:10}, this.gameScale)
        this.button2 = createNewButton(this, this.buttons, {x:550,y:550,w:25,h:10}, this.gameScale)
        this.button3 = createNewButton(this, this.buttons, {x:100,y:1050,w:25,h:10}, this.gameScale)
        ...
        this.lever1 = createNewLever(this, this.levers, {x:550,y:2150,w:50,h:10}, this.gameScale)
        this.lever2 = createNewLever(this, this.levers, {x:600,y:1550,w:50,h:10}, this.gameScale)
        this.lever3 = createNewLever(this, this.levers, {x:250,y:850,w:50,h:10}, this.gameScale)
        this.lever4 = createNewLever(this, this.levers, {x:600,y:1250,w:50,h:10}, this.gameScale)
        ...
        this.movingPlatform1 = createNewMovingPlatform(this, this.movingPlatforms, {x:700,y:2175,w:200,h:50}, {x:700,y:1875}, {x:0,y:-1}, this.lever1, this.gameScale)
        this.movingPlatform2 = createNewMovingPlatform(this, this.movingPlatforms, {x:100,y:1825,w:200,h:50}, {x:100,y:1575}, {x:0,y:-1}, this.button2, this.gameScale)
        this.movingPlatform3 = createNewMovingPlatform(this, this.movingPlatforms, {x:725,y:1525,w:150,h:50}, {x:725,y:1275}, {x:0,y:-1}, this.lever3, this.gameScale)
        this.movingPlatform4 = createNewMovingPlatform(this, this.movingPlatforms, {x:100,y:275,w:200,h:50}, {x:100,y:525}, {x:0,y:1}, this.button1, this.gameScale)
        this.movingPlatform5 = createNewMovingPlatform(this, this.movingPlatforms, {x:700,y:575,w:200,h:50}, {x:700,y:875}, {x:0,y:1}, this.lever2, this.gameScale)
        this.movingPlatform6 = createNewMovingPlatform(this, this.movingPlatforms, {x:100,y:875,w:200,h:50}, {x:300,y:875}, {x:1,y:0}, this.lever4, this.gameScale)
        this.movingPlatform7 = createNewMovingPlatform(this, this.movingPlatforms, {x:100,y:1225,w:200,h:50}, {x:300,y:1225}, {x:1,y:0}, this.button3, this.gameScale)
        ...
        createNewSpikeSet(this, this.spikes, {x:300,y:1850}, 6, this.gameScale)
        ...
        this.enemy1 = createNewEnemy(this, this.enemies, {x:300,y:2125}, 450, 50, this.gameScale)
        this.enemy2 = createNewEnemy(this, this.enemies, {x:300,y:1525}, 550, 50, this.gameScale)
        this.enemy3 = createNewEnemy(this, this.enemies, {x:400,y:1225}, 550, 50, this.gameScale)
        this.enemy4 = createNewEnemy(this, this.enemies, {x:250,y:225}, 500, 50, this.gameScale)
        this.enemy5 = createNewEnemy(this, this.enemies, {x:250,y:525}, 450, 50, this.gameScale)
        this.enemy6 = createNewEnemy(this, this.enemies, {x:400,y:825}, 550, 50, this.gameScale)
        ...
        this.exitDoor = createNewExitDoor(this, this.exitDoors, {x:100,y:1175}, this.movingPlatform7, this.gameScale)
