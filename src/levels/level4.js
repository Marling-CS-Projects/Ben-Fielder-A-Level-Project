...
class Level4 extends Phaser.Scene{
    ...
    create(){
        ...
        this.player1 = createNewPlayer(this, this.players, 50, 2125, this.gameScale, "player")
        this.player2 = createNewPlayer(this, this.players, 750, 225, this.gameScale, "player")
