...
class Level1 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio("grasslands", "music/grasslands.mp3")
    }
    create(){

        this.gameScale = this.scale.canvas.width/800

        this.music = this.sound.add("grasslands")
        ...
        this.player1 = createNewPlayer(this, this.players, 50, 525, this.gameScale, "p1")
        this.player2 = createNewPlayer(this, this.players, 150, 525, this.gameScale, "p2")
